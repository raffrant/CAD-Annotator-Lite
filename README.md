...
Drawing-to-CAD (Drawing2STEP) is a focused hybrid rebuild of CAID Technologies' CAD-Annotator: upload a technical drawing, separate physical items and views with hosted or local vision AI, inspect CAD-style annotation layers, and export validated geometry JSON or STEP.
